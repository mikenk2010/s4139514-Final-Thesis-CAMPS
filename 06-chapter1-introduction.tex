...
The linear, thesis-first pattern dominates the text LLM evaluators
learn from; the inductive, context-first pattern common in many
Asian academic traditions is equally valid but under-represented.}
