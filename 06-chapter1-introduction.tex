...
\citep{hinds1987reader, connor2011intercultural} is equally valid but
under-represented.}
...
Graded ground truth does not exist for the cohort essays, so H4 is
examined on a proxy, association with the corpus's proficiency bands
(Section~\ref{sec:metrics}), and is reported as exploratory.
