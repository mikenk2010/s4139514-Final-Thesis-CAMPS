...
The writer-responsible, thesis-first pattern is plausibly dominant
in the text LLM evaluators learn from, given their measured alignment
with Western values \citep{tao2024cultural}; the reader-responsible,
...
RQ2 & H4 & What narrowing the gap costs (proxy: band association) & E2 \\
\hline
\end{tabular}
\end{table}
