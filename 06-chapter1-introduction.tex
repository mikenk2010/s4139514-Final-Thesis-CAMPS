...
proficiency labels are CEFR bands (B1, B2). \\
\hline
\end{tabular}
\end{table}
...
method: the data, the three experiments (E1 for H1, E2 for H2 and
H4, E3 for H3), the statistical protocol, and the alternatives
