...
\begin{itemize}
  ...
  \item \textbf{H3 (Detection).} A ROC-calibrated Bias Divergence
        Score threshold attains at least 90\% sensitivity at no more
        than a 5\% false-positive rate against multi-rater human
        disagreement on the 140-essay GRA validation set.
