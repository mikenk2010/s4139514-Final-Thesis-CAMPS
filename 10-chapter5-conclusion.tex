...
more than its SEA lens alone; $k$=5 changed it by 0.02 [$-0.02$,
0.06] on GPT-4o (no clear evidence) and $-0.10$ [$-0.15$, $-0.06$]
on Claude (worse); adjudicator no clear change on either; band
association lowered only by the adjudicated configuration on Claude
($-0.06$ [$-0.10$, $-0.03$]). Scope note: the $k$=3 panel amplified
...
small in-sample trade-off on the proxy (exploratory) &
Graded ground truth is absent for the cohort essays, so accuracy is
proxied by band association. 10{,}626-vector sweep: equal weighting
