...
hypotheses of Chapter~1: a systematic scoring gap between
rhetorical-tradition cohorts matched on proficiency (H1); shrinkage
...
bands (A2--B2+), enabling proficiency-matched cohort construction.
...
components of WE; the native cohort from ENS. Both cohorts are
restricted to the two upper proficiency bands (B1\_2, B2+) and
stratified by topic and band, $n \approx 100$ per cohort under a
fixed seed. Restricting to the upper bands narrows the range of
underlying proficiency so that systematic cohort differences cannot
be attributed to proficiency alone, with residual band composition
controlled in analysis. The GRA's 140 essays are retained in full as
E3's validation set.
