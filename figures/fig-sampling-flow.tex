...
\begin{tikzpicture}[
  ...
  \node[mod, right=of we, fill=gray!10] (wep) {WEP v0.7\\2{,}340 essays\\(not scored in E1--E3)};
  ...
  \node[coh, below left=9mm and -6mm of filter] (sea) {SEA cohort\\THA, IDN, PHL\\$n = 100$};
  \node[coh, below right=9mm and -6mm of filter] (ens) {Native cohort\\ENS (unbanded)\\$n = 100$};
